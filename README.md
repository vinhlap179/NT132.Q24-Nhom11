...
64 bytes from 20.20.20.20: icmp_seq=125 ttl=58 time=0.032 ms
</pre>
...
1.Đăng nhập vào các router bằng lệnh docker exec:  
> docker exec -it router1 vtysh

2.Sử dụng các lệnh sau trong vtysh để xác minh OSPF:  
...
Ví dụ:  
1.Bắt đầu chạy lệnh ping từ host1 đến host2  
> docker exec -ti host1 ping 20.20.20.20

2.Xác minh rằng lưu lượng mạng đang đi qua một router, ví dụ: router6  
